...
{	
	...
	public function insertInto($identifiant, $intitule, $reference, $superficie, $objectif, $consistance, $cout, $maitre, $naturem, $taux, $commune, $situation, $intervention, $naturet, $statut, $convention, $remarques ){
		...
		try{
			...
			$stmt = $this->connexion->prepare("INSERT INTO projet(identifiant,intitule,reference,superficie,objectif,consistance,cout,maitre,naturem, taux,commune,situation,intervention,naturet,statut,convention,remarques) 
