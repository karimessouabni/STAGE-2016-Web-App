...
$projet = new Projet();
 ...
 //|| isset($_POST['intitule']) || isset($_POST['reference']) || isset($_POST['cout']) 
    ...
    $result = $projet->insertInto(post('identifiant'), post('intitule'), post('reference'), post('superficie'), post('objectif'), post('consistance'), post('cout'), post('maitre'),post('naturem'), post('taux'), post('commune'), post('situation'), post('intervention'), post('naturet'), post('statut'),post('conventionY'),post('remarques') ) ;
